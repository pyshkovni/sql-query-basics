...
В этом курсе мы будем практиковаться в написании SQL-запросов на наборе данных Dognition в системе управления базами данных `phpmyadmin`. Затем, когда вы освоитесь с синтаксисом запроса, вы попрактикуетесь в самостоятельном написании запроса под заданных сценариев.

## Подключение к базе данных

Для изучения основ SQL, мы будем использовать инструмент работы с базами данных – Yandex WebSQL. Он позволяет подключаться к различным источникам данных и писать SQL-запросы в браузере. 

Для того, чтобы воспользоваться данным инструментом, понадобиться сервис Yandex Cloud и Ваша почту от личного кабинета РАНХиГС. Для подключения выполните следующие шаги:

* [Заполните форму](https://forms.yandex.ru/cloud/6825f32a84227c6efb3453bb), в которой необходимо прислать почту
* Ознакомьтесь с инструкцией для получения доступа [по ссылке](https://docs.google.com/presentation/d/1cmIqHX02TqLEknnUQdl65JE16VSRwSIdgfKI3BTEymU/edit?slide=id.p1#slide=id.p1)
* Ознакомьтесь с инструкцией по работе и сдачей практических заданий [по ссылке](https://docs.google.com/presentation/d/1Y_bLS4JoWciVDrxMsMtTEUzcZKWxno7yZ_-67o3rQjs/edit?slide=id.p1#slide=id.p1)
